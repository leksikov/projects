...
def generate_features(df):
    ...
    df['returns'] = df['price'].diff(1)
    
    df['ROC_2'] =  df['price'].copy().diff(2)
    
    df['ROC_3'] = df['price'].copy().diff(3)
    df['ROC_5'] = df['price'].copy().diff(5)
    df['ROC_20'] = df['price'].copy().diff(20)
    df['ROC_50'] = df['price'].copy().diff(50)
    df['ROC_100'] = df['price'].copy().diff(100)
    df['ROC_200'] = df['price'].copy().diff(200)
    #df['ROC_300'] = np.log(df['price'].copy()).pct_change(300)
    df['ROC_500'] = df['price'].copy().diff(500)
...
def generate_features2(df):
    ...
    df['returns'] = np.log(df['price']).diff(1)
    
    df['ROC_2'] =  np.log(df['price']).copy().diff(2)
    
    df['ROC_3'] = np.log(df['price']).copy().diff(3)
    df['ROC_5'] = np.log(df['price']).copy().diff(5)
    df['ROC_20'] = np.log(df['price']).copy().diff(20)
    df['ROC_50'] = np.log(df['price']).copy().diff(50)
    #df['ROC_100'] = np.log(df['price']).copy().diff(100)
    #df['ROC_200'] = np.log(df['price']).copy().diff(200)
    #df['ROC_300'] = np.log(df['price'].copy()).pct_change(300)
    #df['ROC_500'] = np.log(df['price']).copy().diff(500)
